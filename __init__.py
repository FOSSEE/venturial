...
from venturial.views.mainpanel.view import VNT_OT_active_project_indicator, VNT_OT_list_category
...
classes = (VNT_user_preferences_collection,
...
def register():  
    ...
    register_custom_icon("file-browser-2", "/venturial/icons/custom_icons/file-browser-2.png")
    ...
    bpy.types.Scene.meshing_tool = EnumProperty(items = [("BlockMesh", "BlockMesh", ""),
                                                         ("SnappyHexMesh", "SnappyHexMesh", "")],
                                                default = "BlockMesh",
                                                update = update_current_tool_text_1)

    bpy.types.Scene.solution_tools = EnumProperty(items = [('Solution Modeling', 'Solution Modeling', ''),
    ...
    bpy.types.Scene.mainpanel_categories = EnumProperty(items = [('Explore', 'Explore', ''),
                                                                 ('Geometry', 'Geometry', ''),
                                                                 ('Edges', 'Edges', ''),
    ...
    bpy.types.Scene.cellShapes = EnumProperty(items = [('Hexahedron', 'Hexahedron', ''),
                                                       ...
                                                       ('Tetrahedral wedge (Experimental)', 'Tetrahedral wedge (Experimental)', '')],
                                              default = 'Hexahedron',
    ...
    bpy.types.Scene.pref_pointer = bpy.props.PointerProperty(type=VNT_user_preferences_collection)
    ...
    bpy.types.Scene.tut_item_ptr = bpy.props.PointerProperty(type=tutorialitemproperties)
    bpy.types.Scene.tut_item = CollectionProperty(type=tutorialitemproperties)    
    bpy.types.Scene.tut_item_index = IntProperty()
    
    bpy.types.Scene.rec_item_ptr = bpy.props.PointerProperty(type=recent_item_properties)
    ...
    bpy.types.Scene.edge_control_methods = EnumProperty(items = [('IP', 'Interpolation Points', ''),
                                                                 ('AA', 'Axis angle', '')],
                                                        default = 'IP')

    bpy.types.Scene.curve_type = EnumProperty(items = [('ARC', 'Arc', '', "SPHERECURVE", 0),
    ...
    bpy.types.Scene.active_projects = EnumProperty(description="horizontally placed dynamic list of active projects in the project manager.",
...
def unregister():
    ...
    unregister_custom_icon("file-browser-2", "/venturial/icons/custom_icons/file-browser-2.png")
